  ...
  register() {
    ...
    axios
      ...
      .then(function(response) {
        firebase
          .auth()
          .createUserWithEmailAndPassword(that.state.email, that.state.password)
          .then(function(e) {
  ...
  render() {
    ...
    let renderSectors = this.state.tabSectors.map(e => (
      <div
        ...
        className="InscriptionPage_containerInscription3_div"
      >
        <h1 className="InscriptionPage_containerInscription3_div_title">
          {e.name}
        </h1>
      </div>
    ));
    ...
    return (
      <Page key="InscriptionPage" className="InscriptionPage">
        <svg
          ...
          className="InscriptionPage_arrow"
        ...
        >
          <div>
            ...
            <div className="InscriptionPage_containerInscription">
              <form
                action=""
                method="post"
                className="InscriptionPage_containerInscription_formInscription"
              >
                <input
          ...
          <div>
            ...
            <div className="InscriptionPage_containerInscription2">
              <div
                ...
                className="InscriptionPage_containerInscription2_div"
              >
                <img
                  src={male}
                  alt="logoFemale"
                  className="InscriptionPage_containerInscription2_logo"
                />
              </div>
              <div
                id="male"
              ...
              <div
                ...
                className="InscriptionPage_containerInscription2_div"
              >
                <h2 className="InscriptionPage_containerInscription2_div_other">
                  {" "}
                  Autre{" "}
                </h2>
              </div>
          ...
          <div>
            <h3 className="InscriptionPage_title">
              {" "}
          ...
          <div>
            ...
            <div className="InscriptionPage_containerInscription4">
              <div
                style={style}
                className="InscriptionPage_containerInscription4_pic"
              >
                {this.state.file ? (
              ...
              <select
                ...
                className="InscriptionPage_containerInscription4_espece"
              >
              ...
              <select
                onChange={this.handleChangePlanete}
                className="InscriptionPage_containerInscription4_planete"
              >
                <option value="" selected disabled hidden>
                  Votre planète
                </option>
        ...
        <img
          ...
          src={arrowRight}
          alt="NextStep"
          className="InscriptionPage_icon"
        />
