...
class Profile extends Component {
    ...
    closeModalDeleteTrue() {
        ...
        if(this.state.id !== null) {
            ...
            axios.delete('http://localhost:8000/api/users/'+this.state.profile)
                .then((e) => {
                    window.location.href = "/";
                })
                .catch((error) => console.log(error))
    ...
    return (
        <Page key="ProfilePage" className="ProfilePage">
            ...
            <MediaQuery query="(min-width: 421px)">
                <div className="HomePageDesktop_sideBar">
                    ...
                    <div className="HomePageDesktop_sideBar_nav">
                        <div className="HomePageDesktop_sideBar_items">
                            ...
                            <a className="HomePageDesktop_sideBar_items_links" href={"/profile/"+this.state.id}><span className="HomePageDesktop_sideBar_items_span">Profil</span></a>
                        </div>
                        <div className="HomePageDesktop_sideBar_items">
                            ...
                            <a className="HomePageDesktop_sideBar_items_links" href={"/home/"+this.state.id}>Carte</a>
                        </div>
                        <div className="HomePageDesktop_sideBar_items">
                ...
                <div className=""> <img className="ProfilePageDesktop_image" src={imagesFolder[this.state.image]} alt=""/> </div>
                ...
                >
                    <div className="ProfilePageDesktop_modal_delete">
                        ...
                        <input onClick={this.closeModalDeleteFalse}  value="Non" type="button" className="ProfilePageDesktop_modal_delete_input_left"/>
                        <input onClick={this.closeModalDeleteTrue} value="Oui" type="button" className="ProfilePageDesktop_modal_delete_input_right"/>
                    </div>
                </Modal>
            </MediaQuery>
