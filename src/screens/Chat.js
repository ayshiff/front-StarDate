                    ...
                    <div className="ChatPageDesktop">
                        <div className="HomePageDesktop_sideBar">
                            ...
                            <div className="HomePageDesktop_sideBar_nav">
                                ...
                                <div className="HomePageDesktop_sideBar_items">
                                    <svg className="HomePageDesktop_sideBar_items_icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="35" height="28"><path fill="#F04240"  d="M256 32C114.6 32 0 125.1 0 240c0 49.6 21.4 95 57 130.7C44.5 421.1 2.7 466 2.2 466.5c-2.2 2.3-2.8 5.7-1.5 8.7S4.8 480 8 480c66.3 0 116-31.8 140.6-51.4 32.7 12.3 69 19.4 107.4 19.4 141.4 0 256-93.1 256-208S397.4 32 256 32z"/></svg>
                                    <a className="HomePageDesktop_sideBar_items_links" href={"/chat/"+this.state.id}><span className="HomePageDesktop_sideBar_items_span">Message</span></a>
                                </div>
                            </div>
                        </div>
