...
class Main extends Component {
  ...
  renderTabs() {
    ...
    return [
      {
        content: <Profile nav={this.props.navigator} />,
        tab: <Tab className="Profile" icon="fa-user-circle" />
      },
      {
        content: <Home nav={this.props.navigator} />,
        tab: <Tab className="TabP" icon="fa-map" />
      },
      {
        content: <ChatHome nav={this.props.navigator} />,
        tab: <Tab className="Chat" icon="fa-comment" />
      }
    ];
  }
