  ...
  render() {
    ...
    function renderSwitch(index) {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        if (index === i) {
          tab.push(
            <img key={i} src={OvalToggle} alt="oval" className={classe} />
          );
        } else {
    ...
    let content1 = () => (
      <div className="homeDesktop_inscriptionContainer">
        <h3 className="homeDesktop_createAccount">
          Créez vous <span className="homeDesktop_coloriage">un compte </span>
        </h3>
        <div className="homeDesktop_containerInscription">
          <form action="" method="post" className="homeDesktop_formInscription">
            <div className="homeDesktop_flexName">
              <input
                className="homeDesktop_inputItemForm"
                type="text"
                name="email"
                id="nom"
                placeholder="Nom*"
          ...
          <button
            onClick={this.registerDesktop}
            className="homeDesktop_inscriptionBtn"
          >
            S'inscrire
          </button>
        </div>
      ...
      <div className="homeDesktop_inscriptionContainer">
        ...
        <div className="homeDesktop_containerInscription">
          <div className="homeDesktop_titleContainerStep2">
            <h3 className="homeDesktop_titleStep2">Vous êtes ?</h3>
          </div>
          <div className="homeDesktop_containerInscription2">
            <div
              onClick={this.onItemClickState}
              className="homeDesktop_logoStep2Container"
            >
              <img
                src={desktopmale}
                alt="logoFemale"
                className="homeDesktop_logoStep2"
              />
            </div>
            <div
              onClick={this.onItemClickState}
          ...
          <div className="homeDesktop_titleContainerStep2">
            <h3 className="homeDesktop_titleStep2">Vous recherchez ?</h3>
          </div>
          <div className="homeDesktop_containerInscription2">
            <div
              onClick={this.onItemClickSearch}
              className="homeDesktop_logoStep2Container"
            >
              <img
                src={desktopmale}
      ...
      <div className="homeDesktop_inscriptionContainer">
        ...
        <div className="homeDesktop_containerInscription">
          <h3 className="homeDesktop_titleStep2">
            Selectionner{" "}
            <span className="homeDesktop_coloriage">votre galaxie.</span>
          </h3>
          <div className="homeDesktop_buttonGalaxyContainer">
            <button
              onClick={this.onItemClick}
              className="homeDesktop_buttonGalaxy"
            >
              Voie lactée
            </button>
          </div>
    ...
    let content4 = () => (
      <div className="homeDesktop_inscriptionContainer">
        ...
        <div className="homeDesktop_containerInscription">
          <h3 className="homeDesktop_titleStep2">
            Dites nous en <span className="homeDesktop_coloriage">plus.</span>
          </h3>
          <div className="homeDesktop_formInscription">
            <div className="homeDesktop_profileContainer">
              <div className="homeDesktop_profileItemContainer">
                <div className="homeDesktop_profileItems">
                  <div className="homeDesktop_inputItemFormImgContainer">
                    ...
                    <input
                      className="homeDesktop_inputItemFormImg"
                      type="file"
                      accept=".jpg, .jpeg, .png"
                      name="photo"
                      id="upload-photo"
                ...
                <div className="homeDesktop_profileItems">
                  <select
                    className="homeDesktop_selectItemForm"
                    name="Votre planete"
                    size=""
                    id="age"
                    placeholder="age*"
                  >
                    <option className="homeDesktop_selectOption">
                      Votre planete
                    </option>
                  </select>
                  <select
              ...
              <div className="homeDesktop_bioContainer">
                <input
                  className="homeDesktop_bioContent"
                  type="text"
      ...
      <Page className="LoginPage">
        <Modal isOpen={this.state.modalIsOpen}>
          <div className="LoginPage_modal">
            <p className="LoginPage_modal_p">Ecrivez votre email</p>
            <input type="text" placeholder="Email" />
            <p>
              <button onClick={this.closeModal}>Envoyer</button>
            </p>
          </div>
        </Modal>
        <MediaQuery query="(max-width: 420px)">
          <ReactSwipe
            className="LoginPage_carousel"
            swipeOptions={{
              continuous: false,
              speed: 400,
          ...
          >
            <div>
              ...
              <img
                src={planet}
                alt="logo"
                className="LoginPage_carousel_planet"
              />
              <img src={logo} alt="logo" className="LoginPage_carousel_logo" />
              <img
                src={stars1}
                alt="logo"
                className="LoginPage_carousel_stars1"
              />
              <img
                src={stars2}
                alt="logo"
                className="LoginPage_carousel_stars2"
              />
            </div>
            ...
            <div className="LoginPage_carousel_div">
              ...
              <img
                src={placeholder}
                alt="logo"
                className="LoginPage_carousel_div_img2"
              />
            </div>
            <div className="LoginPage_carousel_div">
              <div className="LoginPage_carousel_textLogin">
              ...
              <img
                src={placeholder2}
                alt="logo"
                className="LoginPage_carousel_div_img3"
              />
            </div>
          </ReactSwipe>
          ...
          <div className="containerLogin">
            <div className="containerLogin_formLogin">
              ...
              <div className="containerLogin_formLogin_buttons">
                <button
                  className="containerLogin_formLogin_buttons_create"
                  onClick={this.pushPageInscription}
                >
                  Créer un compte
                </button>
                <button
                  className="containerLogin_formLogin_buttons_connect"
          ...
          <div className="homeDesktop">
            <div className="homeDesktop_inputContainer">
              ...
              <div className="homeDesktop_container">
                <input
                  onChange={this.emailChange}
                  className="homeDesktop_inputItem"
                  type="email"
                  name="email"
                  id="email"
                  placeholder="Email"
                ...
                />
                <button
                  className="homeDesktop_btnConnexion"
                  onClick={this.loginActionDesktop}
                >
                  Se connecter
                </button>
                <div className="homeDesktop_forgottenContainer">
                  <p onClick={this.openModal} className="homeDesktop_forgotten">
                    Mot de passe oublié ?
                  </p>
                </div>
              </div>
            ...
            <div className="homeDesktop_bigContainer">
              ...
              <div className="homeDesktop_textContainer">
                <p className="homeDesktop_textTitle">
                  ...
                  le{" "}
                  <span className="homeDesktop_coloriage">
                    1er site de rencontre <br />
                    intergalactique.
                  </span>
                </p>
