                ...
                <div className="HomePageDesktop_sideBar">
                  ...
                  <div className="HomePageDesktop_sideBar_nav">
                    <div className="HomePageDesktop_sideBar_items">
                      ...
                      <a className="HomePageDesktop_sideBar_items_links" href="">Profil</a>
                    </div>
                    <div className="HomePageDesktop_sideBar_items">
                      ...
                      <a className="HomePageDesktop_sideBar_items_links" href=""><span className="HomePageDesktop_sideBar_items_span">Carte</span></a>
                    </div>
                    <div className="HomePageDesktop_sideBar_items">
                      ...
                      <a className="HomePageDesktop_sideBar_items_links" href="">Message</a>
                    </div>
                  </div>
                </div>
