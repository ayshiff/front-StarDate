                ...
                <div className="HomePageDesktop_sideBar">
                  ...
                  <div className="HomePageDesktop_sideBar_nav">
                    <div className="HomePageDesktop_sideBar_items">
                      ...
                      <a className="HomePageDesktop_sideBar_items_links" href={"/profile/"+this.props.match.params.id}>Profil</a>
                    </div>
                    <div className="HomePageDesktop_sideBar_items">
                      ...
                      <a className="HomePageDesktop_sideBar_items_links" href={"/home/"+this.props.match.params.id}><span className="HomePageDesktop_sideBar_items_span">Carte</span></a>
                    </div>
                    <div className="HomePageDesktop_sideBar_items">
