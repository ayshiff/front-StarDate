...
class Home extends Component {
  ...
  handleClick(element) {
    let that = this;
    axios
      .get("http://localhost:8000" + element.position)
      .then(function(e) {
        that.setState({
  ...
  render() {
    ...
    this.state.users.map(e => {
      ...
      tabUsers.push(
        <img
          className="HomePageDesktop_map_profiles_pic"
          src={imagesFolder[e.image]}
          onClick={this.pushPageProfile.bind(this, e)}
          style={{
            top: randomPositionY,
    ...
    this.state.users.map(e => {
      let randomPositionX =
        Math.floor(Math.random() * (97 - 30 + 1)) + 30 + "%";
      let randomPositionY = Math.floor(Math.random() * (90 - 0 + 1)) + 0 + "%";
      tabUsersDesktop.push(
        <img
          className="HomePageDesktop_map_profiles_pic"
          src={imagesFolder[e.image]}
    ...
    let modal = (
      <div className="HomePageDesktop_view_modal">
        <img
          className="HomePageDesktop_view_modal_pic"
          src={imagesFolder[this.state.image]}
          alt="profilePic"
        />
        <h2 className="HomePageDesktop_view_modal_name">
          {this.state.name},{" "}
          <span className="HomePageDesktop_view_modal_age">
            {this.state.age}
          </span>
        </h2>
        <p className="HomePageDesktop_view_modal_planet">
          {this.state.position}
        </p>
        <h4 className="HomePageDesktop_view_modal_about">À propos</h4>
        <p className="HomePageDesktop_view_modal_descri">
    ...
    return (
      <Page key="HomePage" className="HomePage">
          ...
          <div className="HomePageDesktop">
            <div className="HomePageDesktop_sideBar">
              <img
                ...
                src={imagesFolder[this.state.imageUser]}
                alt="profilePic"
              />
            ...
            <div className="HomePageDesktop_map">
              <div className="HomePageDesktop_map_myPosition">
                <img
                  src={imagesFolder[this.state.imageUser]}
                  className="HomePageDesktop_map_myPosition_mask1"
                />
                <img
                  src={mask2}
                  className="HomePageDesktop_map_myPosition_mask2"
                />
                <img
                  src={mask3}
                  className="HomePageDesktop_map_myPosition_mask3"
                />
                <img
                  src={mask4}
                  className="HomePageDesktop_map_myPosition_mask4"
                />
              </div>
            ...
            <div
              ...
              className="HomePageDesktop_view"
            >
              {modal}
            </div>
          </div>
        ...
        <MediaQuery query="(max-width: 420px)">
          ...
          >
            <div
              className="HomePage_carousel1"
              style={{ color: "white", height: "90vh" }}
            />
            <div
              className="HomePage_carousel2"
              style={{ color: "white", height: "90vh" }}
            >
              {tabUsers}
              <div className="HomePage_carousel2_loading">
                <img
                  ...
                  className="HomePage_carousel2_loading_mask1"
                />
